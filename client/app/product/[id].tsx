  ...
  return (
    <View className="flex-1 bg-white">
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View className="px-5">
          ...
          {product.sizes && product.sizes.length > 0 && (
            <>
              <Text className="text-base font-bold text-primary">Size</Text>
      ...
      <View className="absolute bottom-0 left-0 flex-row right-0 p-4 bg-white border-t border-gray-100">
        ...
        <TouchableOpacity onPress={() => router.push("/(tabs)/cart")} className="relative w-1/5 py-3 flex-row justify-center">
